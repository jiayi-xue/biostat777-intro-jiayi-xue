...
The intended audience for the data analysis appears to be data analysts and enthusiasts who participate in TidyTuesday, a weekly social data project in the R programming community. The project aims to engage users in creating visualizations and analyses of a given dataset.
...
: You can also find the data dictionary [here](https://github.com/rfordatascience/tidytuesday/blob/master/data/2021/2021-02-09/readme.md_)
